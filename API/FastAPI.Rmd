...
class Repository(BaseModel):
    ...
    repo_name: str = Field(
        ...
        example="gslicraf/geo-api"
    )
    repo_url: str = Field(
        "https://hub.docker.com/r/gslicraf/geo-api",
        title="image url on dockerhub registry",
        example="https://hub.docker.com/r/gslicraf/geo-api"
    )
...
class Payload(BaseModel):
    callback_url: str = Field(
        "https://registry.hub.docker.com/u/gslicraf/geo-api/hook/2jg2hgehh4wAYi0eaimEAQ8SCO4qe2CW2/",
        title="dockerhub chain confirmation url",
        example="https://registry.hub.docker.com/u/gslicraf/geo-api/hook/2jg2hgehh4wAYi0eaimEAQ8SCO4qe2CW2/"
    )
    push_data: PushData
...
async def payload_handler(payload: Payload, background_tasks: BackgroundTasks):
    ...
    """
    valid_accounts = ['jaysnm', 'gslicraf']
...
* Configure the app to run as a systemd app (for linux users).   
